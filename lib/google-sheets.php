...
class GSCWOO_googlesheet {
   ...
   const clientId = '343006833383-c73msaal124n0psi2fqb5q30u8j2p495.apps.googleusercontent.com';
   const clientSecret = 'k5ThyeLrjEZi0wOhqHhKoWdq';
   ...
   public static function preauth( $access_code ) {
      ...
      $client->setClientId( GSCWOO_googlesheet::clientId );
      $client->setClientSecret( GSCWOO_googlesheet::clientSecret );
      $client->setRedirectUri( GSCWOO_googlesheet::redirect );
